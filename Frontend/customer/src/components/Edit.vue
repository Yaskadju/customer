<template>
  <div class="edit container">
    ...
    <h1 class="page-header"><br/>Edit Customer</h1>
  ...
  methods: {
    ...
    updateCustomer: function(e){
      ...
      || !this.customer.email){
        ...
        this.$http.put('http://localhost:8090/customer/webapi/customers/'+this.$route.params.id, updCustomer)
        .then(function(response){
          this.$router.push({path: '/', query: {alert: 'Customer Update!'}});
        });
        e.preventDefault();
      }
      e.preventDefault();
